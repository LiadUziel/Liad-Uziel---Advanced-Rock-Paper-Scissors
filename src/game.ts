...
export class Game {
  ...
  constructor(player1Type: PlayerType, player2Type: PlayerType, numberOfRounds: number, numberOfHands: number) {
    // Input from user
  ...
  async start(): Promise<void> {
    const [player1, player2] = GameHelper.buildPlayersByType(this.player1Type, this.player2Type);
